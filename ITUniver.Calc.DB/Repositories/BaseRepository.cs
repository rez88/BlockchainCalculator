...
namespace ITUniver.Calc.DB.Repositories
{
        ...
        where T : class, IEntity
    {
        ...
        protected string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\work\BlockchainCalculator\ITUniver.Calc.DB\App_Data\CalcDB.mdf;Integrated Security=True";
